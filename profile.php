                        ...
                        <div class="tabbable tabbable-custom tabbable-full-width">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane profile-classic row-fluid active" id="tab_1_2">
                                    <div class="span2"><img src="assets/img/profile/profile-img.png" alt="" /> <a
                                            href="#" class="profile-edit">edit</a></div>
                                    <ul class="unstyled span10">
                                        <li><span>User Name:</span> <?php echo $_SESSION['sessusername']; ?></li>
                                        ...
                                        <li><span>Website Url:</span> <a href="#">/a></li>
                                                        ...
                                                        <div style="height: auto;" id="accordion1-1"
                                                            ...
                                                            <form action="#">
                                                                ...
                                                                <div class="controls">
                                                                    ...
                                                                    <p class="help-block"><span class="muted">Start
                                                                            typing to auto complete!. E.g: US</span></p>
                                                                </div>
                                                    ...
                                                    <div id="tab_4-4" class="tab-pane">
                                                        <div style="height: auto;" id="accordion4-4"
                                                            ...
                                                            <form action="#">
                                                                ...
                                                                <div class="profile-settings row-fluid">
                                                                    <div class="span9">
                                                                        <p>Oiusmod high life accusamus terry richardson
                                                                            ad squid wolf fwopo</p>
                                                                    </div>
                                                                    <div class="control-group span3">
                                                                        <div class="controls">
                                                                            <label class="checkbox">
